...
/**
   ...
   * @param {SweetAlertOptions} params
   * @param {string} className
   */var G=function applyCustomClass(e,t,n){Y(e,t);if(t.customClass){var a=t.customClass[/** @type {keyof SweetAlertCustomClass} */n];a&&(typeof a==="string"||a.forEach?ee(e,a):p("Invalid type of customClass.".concat(n,'! Expected string or iterable object, got "').concat(_typeof(a),'"')))}};
/**
...
/**
   ...
   * @param {SweetAlertOptions} params
   */var Se=function renderActions(e,t){var n=V();var a=H();if(n&&a){t.showConfirmButton||t.showDenyButton||t.showCancelButton?re(n):oe(n);G(n,t,"actions");renderButtons(n,a,t);$(a,t.loaderHtml||"");G(a,t,"loader")}};
/**
...
/**
   ...
   * @param {SweetAlertOptions} params
   */function renderButton(e,t,n){var a=/** @type {'Confirm' | 'Deny' | 'Cancel'} */d(t);le(e,n["show".concat(a,"Button")],"inline-block");$(e,n["".concat(t,"ButtonText")]||"");e.setAttribute("aria-label",n["".concat(t,"ButtonAriaLabel")]||"");e.className=s[t];G(e,n,"".concat(t,"Button"))}
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var Ee=function renderCloseButton(e,t){var n=R();if(n){$(n,t.closeButtonHtml||"");G(n,t,"closeButton");le(n,t.showCloseButton);n.setAttribute("aria-label",t.closeButtonAriaLabel||"")}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var _e=function renderContainer(e,t){var n=C();if(n){handleBackdropParam(n,t.backdrop);handlePositionParam(n,t.position);handleGrowParam(n,t.grow);G(n,t,"container")}};
/**
...
/**
   ...
   */var He=function setAttributes(e,t){var n=A();if(n){var a=X(n,e);if(a){Me(a);for(var r in t)a.setAttribute(r,t[r])}}};
/**
   * @param {SweetAlertOptions} params
   */var Ve=function setCustomClass(e){if(e.input){var t=Re(e.input);t&&G(t,e,"input")}};
/**
...
/**
   ...
   * @param {SweetAlertOptions} params
   * @returns {HTMLInputElement}
   */Fe.checkbox=function(e,t){var n=X(A(),"checkbox");n.value="1";n.checked=Boolean(t.inputValue);var a=e.querySelector("span");$(a,t.inputPlaceholder);return n};
/**
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var Ne=function renderContent(e,t){var n=S();if(n){ie(n);G(n,t,"htmlContainer");if(t.html){Ae(t.html,n);re(n,"block")}else if(t.text){n.textContent=t.text;re(n,"block")}else oe(n);Le(e,t)}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var We=function renderFooter(e,t){var n=D();if(n){ie(n);le(n,t.footer,"block");t.footer&&Ae(t.footer,n);G(n,t,"footer")}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var Ue=function renderIcon(e,t){var n=Ie.innerParams.get(e);var a=P();if(a)if(n&&t.icon===n.icon){Ge(a,t);Ke(a,t)}else if(t.icon||t.iconHtml)if(t.icon&&Object.keys(c).indexOf(t.icon)===-1){f('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon,'"'));oe(a)}else{re(a);Ge(a,t);Ke(a,t);ee(a,t.showClass&&t.showClass.icon)}else oe(a)};
/**
   * @param {HTMLElement} icon
   * @param {SweetAlertOptions} params
   */var Ke=function applyStyles(e,t){for(var n=0,a=Object.entries(c);n<a.length;n++){var r=_slicedToArray(a[n],2),o=r[0],i=r[1];t.icon!==o&&te(e,i)}ee(e,t.icon&&c[t.icon]);Xe(e,t);$e();G(e,t,"icon")};var $e=function adjustSuccessIconBackgroundColor(){var e=A();if(e){var t=window.getComputedStyle(e).getPropertyValue("background-color");
...
/**
   * @param {HTMLElement} icon
   * @param {SweetAlertOptions} params
   */var Ge=function setContent(e,t){if(t.icon||t.iconHtml){var n=e.innerHTML;var a="";if(t.iconHtml)a=Je(t.iconHtml);else if(t.icon==="success"){a=Ze;n=n.replace(/ style=".*?"/g,"")}else if(t.icon==="error")a=Ye;else if(t.icon){var r={question:"?",warning:"!",info:"i"};a=Je(r[t.icon])}n.trim()!==a.trim()&&$(e,a)}};
/**
   * @param {HTMLElement} icon
   * @param {SweetAlertOptions} params
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var Qe=function renderImage(e,t){var n=E();if(n)if(t.imageUrl){re(n,"");n.setAttribute("src",t.imageUrl);n.setAttribute("alt",t.imageAlt||"");ae(n,"width",t.imageWidth);ae(n,"height",t.imageHeight);n.className=s.image;G(n,t,"image")}else oe(n)};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
...
/**
   * @param {HTMLElement} popup
   * @param {SweetAlertOptions} params
   */var tt=function addClasses(e,t){var n=t.showClass||{};e.className="".concat(s.popup," ").concat(ce(e)?n.popup:"");if(t.toast){ee([document.documentElement,document.body],s["toast-shown"]);ee(e,s.toast)}else ee(e,s.modal);G(e,t,"popup");typeof t.customClass==="string"&&ee(e,t.customClass);t.icon&&ee(e,s["icon-".concat(t.icon)])};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var ot=function renderTitle(e,t){var n=T();if(n){ie(n);le(n,t.title||t.titleText,"block");t.title&&Ae(t.title,n);t.titleText&&(n.innerText=t.titleText);G(n,t,"title")}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
...
/**
   * @param {KeyboardEvent} event
   * @param {SweetAlertOptions} innerParams
   */var gt=function handleEnter(e,t){if(v(t.allowEnterKey)){var n=X(A(),t.input);if(e.target&&n&&e.target instanceof HTMLElement&&e.target.outerHTML===n.outerHTML){if(["textarea","file"].includes(t.input))return;lt();e.preventDefault()}}};
/**
   * @param {KeyboardEvent} event
...
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var Wt=function handleInputOptionsAndValue(e,t){if(t.input==="select"||t.input==="radio")Yt(e,t);else if(["text","email","number","tel","textarea"].some((function(e){return e===t.input}))&&(g(t.inputValue)||y(t.inputValue))){Ft(O());Gt(e,t)}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} innerParams
...
/**
     ...
     */
var a=function processInputOptions(e){t.input==="select"?populateSelectOptions(n,Xt(e),t):t.input==="radio"&&populateRadioOptions(n,Xt(e),t)};if(g(t.inputOptions)||y(t.inputOptions)){Ft(O());b(t.inputOptions).then((function(t){e.hideLoading();a(t)}))}else _typeof(t.inputOptions)==="object"?a(t.inputOptions):f("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(_typeof(t.inputOptions)))}};
/**
   * @param {SweetAlert} instance
   * @param {SweetAlertOptions} params
   */var Gt=function handleInputValue(e,t){var n=e.getInput();if(n){oe(n);b(t.inputValue).then((function(a){n.value=t.input==="number"?"".concat(parseFloat(a)||0):"".concat(a);re(n);n.focus();e.hideLoading()})).catch((function(t){f("Error in inputValue promise: ".concat(t));n.value="";re(n);n.focus();e.hideLoading()}))}};
/**
   * @param {HTMLElement} popup
...
var t=[];e instanceof Map?e.forEach((function(e,n){var a=e;_typeof(a)==="object"&&(a=Xt(a));t.push([n,a])})):Object.keys(e).forEach((function(n){var a=e[n];_typeof(a)==="object"&&(a=Xt(a));t.push([n,a])}));return t};
/**
   * @param {string} optionValue
...
/**
   ...
   *
   * @returns {HTMLInputElement | null}
   */function getInput(){var t=Ie.innerParams.get(this||e);var n=Ie.domCache.get(this||e);return n?X(n.popup,t.input):null}
/**
   * @param {SweetAlert} instance
...
/**
   ...
   */function fire(){for(var t=arguments.length,n=new Array(t),a=0;a<t;a++)n[a]=arguments[a];return _construct(this||e,n)}
/**
   ...
   * @returns {SweetAlert}
   */function mixin(t){var n=function(n){function MixinSwal(){_classCallCheck(this||e,MixinSwal);return _callSuper(this||e,MixinSwal,arguments)}_inherits(MixinSwal,n);return _createClass(MixinSwal,[{key:"_main",value:function _main(n,a){return _superPropGet(MixinSwal,"_main",this||e)([n,Object.assign({},t,a)])}}])}(this||e);return n}
/**
...
/** @type {DocumentFragment} */var n=t.content;aa(n);var a=Object.assign(Gn(n),Xn(n),Jn(n),Qn(n),ea(n),ta(n),na(n,Zn));return a};
/**
   * @param {DocumentFragment} templateContent
   * @returns {Record<string, any>}
   */var Gn=function getSwalParams(e){
...
/**
   * @param {DocumentFragment} templateContent
   * @returns {Record<string, any>}
   */var Xn=function getSwalFunctionParams(e){
/** @type {Record<string, any>} */
var t={};
...
/**
   ...
   */var sa=function swalOpenAnimationFinished(e){var t=A();if(e.target===t&&Te){var n=C();t.removeEventListener(Te,sa);n.style.overflowY="auto"}};
/**
   * @param {HTMLElement} container
   * @param {HTMLElement} popup
...
/**
   ...
   * @param {SweetAlertOptions} innerParams
   * @param {Function} dismissWith
   */var ga=function setupTimer(e,t,n){var a=z();oe(a);if(t.timer){e.timeout=new $n((function(){n("timer");delete e.timeout}),t.timer);if(t.timerProgressBar){re(a);G(a,t,"timerProgressBar");setTimeout((function(){e.timeout&&e.timeout.running&&fe(t.timer)}))}}};
/**
